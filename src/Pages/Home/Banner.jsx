      ...
      >
        ...
        <SwiperSlide>
          ...
          <div className="overlay h-full w-full max-auto px-12 xl:px-16 text-white flex justify-center items-center">
            <Zoom>
            <h1 className="text-white uppercase">
              Unleash Your Travel Wanderlust
            </h1>
            </Zoom>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          ...
          <div className="overlay h-full w-full max-auto px-12 xl:px-16 text-white flex justify-center items-center">
            <Zoom>
            <h1 className="text-white uppercase">
              Escape to New Travel Horizons
            </h1>
            </Zoom>
          </div>
        </SwiperSlide>
        <p className="absolute top-1/2 -translate-y-1/2 text-white right-0 z-10 bg-[#2D2F81] p-2 md:pl-2 md:p-3 rounded-l-md">
          <FaArrowCircleRight className="text-2xl" />
        </p>
        <p className="absolute top-1/2 -translate-y-1/2 text-white left-0 z-10 bg-[#2D2F81] p-2 md:p-3 md:pl-2 rounded-r-md">
